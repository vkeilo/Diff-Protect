...
# device: 0
# max_exp_num: 100
EXPERIMENT_NAME = "PhotoGuard"
test_lable = f"{EXPERIMENT_NAME}_SD21_VGGFace2_random50_r4p8p12p16_test"
...
params_options = {
    ...
    "target_rate": [1],
    "max_exp_num": [100],
    "model_path":['/data/home/yekai/github/DiffAdvPerturbationBench/Algorithms/Diff-Protect/ckpt/model.ckpt'],
